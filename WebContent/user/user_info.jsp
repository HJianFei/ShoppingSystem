					...
					<form action="${pageContext.request.contextPath}/user!update"
						...
						<table align="center" width="auto" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<td>${request.user.user_pass}</td>
							</tr>
							<tr>
								<td align="right">会员昵称：</td>
								<td>${request.user.user_nickname}</td>
							</tr>
							<tr>
								<td align="right">会员性别：</td>
								<td>${request.user.user_sex}</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>${request.user.user_email}</td>
							</tr>
							<tr>
								<td align="right">会员地址：</td>
								<td colspan="2">${request.user.user_address }</td>
							</tr>
							<tr>
								<td align="right">备注：</td>
								<td colspan="2">${request.user.user_remark }</td>
							</tr>
							<tr>
