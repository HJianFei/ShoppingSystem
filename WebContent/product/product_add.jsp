					...
					<form action="${pageContext.request.contextPath}/product!save"
						...
						<table align="center" width="auto" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td><input type="text" name="product.product_number" /></td>
							</tr>
							<tr>
								<td align="right" width="90">商品名称：</td>
								<td><input type="text" name="product.product_name" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="product.product_amount" /></td>
							</tr>
							<tr>
								<td align="right">商品价格：</td>
								<td><input type="text" name="product.product_price" /></td>
							</tr>
							<tr>
